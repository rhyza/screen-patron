...
function InstagramIcon(props: IconProps) {
  const {classNames, ...attributes} = props;
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1000 1000' fill='currentColor' className={`w-6 h-6 ${classNames}`} {...attributes}>
...
function LinkIcon(props: IconProps) {
  const {classNames, ...attributes} = props;
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='currentColor' className={`w-6 h-6 ${classNames}`} {...attributes}>
...
function TwitterIcon(props: IconProps) {
  const {classNames, ...attributes} = props;
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 248 204' fill='currentColor' className={`w-6 h-6 ${classNames}`} {...attributes}>
...
export { ClockIcon, EditIcon, InstagramIcon, LinkIcon, MapPinIcon, TicketIcon, TwitterIcon, UserGroupIcon };